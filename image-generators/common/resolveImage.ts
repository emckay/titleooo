...
// From: https://github.com/vercel/satori/blob/bdd0dca29bf63e2188d5504b86fc5c0041b8bcc0/src/utils.ts
export function parseViewBox(viewBox?: string | null | undefined) {
  return viewBox ? viewBox.split(/[, ]/).filter(Boolean).map(Number) : null;
}

// From: https://github.com/vercel/satori/blob/bdd0dca29bf63e2188d5504b86fc5c0041b8bcc0/src/handler/image.ts
